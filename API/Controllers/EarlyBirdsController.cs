...
namespace API.Controllers
{
    ...
    public class EarlyBirdsController : ControllerBase
    {
        ...
        // GET: api/EarlyBirds
        [HttpGet]
        public async Task<ActionResult<IEnumerable<EarlyBird>>> GetEarlyBirds()
        {
            return await _context.EarlyBirds.ToListAsync();
        }
        ...
        {
            var earlyBird = await _context.EarlyBirds.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteEarlyBird(int id)
        {
            ...
            _context.EarlyBirds.Remove(earlyBird);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.EarlyBirds.Any(e => e.EarlyBirdID == id);
        }
    }
}
